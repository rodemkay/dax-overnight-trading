...
$_QUERY=array(); // Массив
$result=mysqli_query($db,"SELECT full_name,program,test,ip,serialNo FROM `lnative`");
...
?>
  ...
  <tr class="first_tr">
	...
	<th style="text-align:center;">Affil</th>
    ...
    while($res = mysqli_fetch_assoc($result)) {
		...
		if($roboStatus == 'yes' || $roboStatus == '1' || $roboStatus == 1) {
			echo '<td style="text-align:center;"><span style="color:#00AA00;font-weight:bold;" title="Affiliate">✓</span></td>';
		} else {
			echo '<td style="text-align:center;"><span style="color:#AA0000;" title="No Affiliate">✗</span></td>';
		}
