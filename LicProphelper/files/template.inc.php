...
?>
  ...
  <tr class="first_tr">
	...
	<th title="RoboForex Affiliate Status">Affiliate</th>
	<th>Del</th>
	</tr>
    <?php
    ...
    while($res = mysqli_fetch_assoc($result)) {
		...
		$affiliateStatus = isset($res['roboaffiliate']) && $res['roboaffiliate'] == 'yes' ? 
		                  '<span style="color:green;">✓</span>' : 
		                  '<span style="color:gray;">-</span>';
		echo '<td style="text-align:center;">'.$affiliateStatus.'</td>';
	 ...
	 $success=true;
	  ...
	  $z++;
		...
		$affiliateStatus = isset($res['roboaffiliate']) && $res['roboaffiliate'] == 'yes' ? 
		                  '<span style="color:green;">✓</span>' : 
		                  '<span style="color:gray;">-</span>';
		$_SESSION['search'][$z-1].= '<td style="text-align:center;">'.$affiliateStatus.'</td>';
